...
function getTraitErrors(monster, traitSlotIndex) {
  ...
  if (
    !(traitSlotIndex >= 2) &&
    (monster.class === "Rodian Master" ||
      monster.class === "Nether Boss" ||
      monster.class === "Backer" ||
      monster.creature === "Zantai Material" ||
      monster.class === "Pandemonium")
  )
    return "This trait cannot be found on a playable creature and cannot be placed in a creature slot.";
  if (
    traitSlotIndex >= 2 &&
    (monster.material_name === "N/A" ||
      monster.material_name === "No Material Exists")
  )
